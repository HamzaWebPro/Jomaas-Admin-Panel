    ...
    return (
        <div className="pt-[80px] p-[10px] w-full">
            <div className="confirmOrder-head mb-[50px]">
                <h2 className='text-3xl font-bold text-center mt-5 text-p-red'>Confirm Orders</h2>
            </div>
            ...
            <div className="confirmOrder-main">
                <div className="confirmOrder-inner flex flex-col flex-col-reverse">
                    {dataArr.map((item, index) => (
                    <div key={index} className="confirmOrder-item p-[15px] shadow-lg">
                        <div className="flex justify-center">
                            <h2 className='font-bold text-[50px] text-p-blue mb-[15px]'>{index}</h2>
                        </div>
                       <div className="flex gap-3 justify-end">
                            <button className='font-semibold text-[20px] text-white bg-blue-500 py-[15px] px-[20px] rounded-lg'
                            onClick={()=> setShowOrderDetail(true) }
                            >
                                Detail
                            </button>
                            <button className='font-semibold text-[20px] text-white bg-red-500 py-[15px] px-[20px] rounded-lg'>Reject</button>
                       </div>
                    </div>
                     ))}
